...
<body class="gray-bg">
	...
	<!-- 导入 -->
	<div class="modal fade" id="modal_user_edit_in" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_in" method="post" action="reserveStu.htm" enctype="multipart/form-data">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<td>爱好</td>
								<td>
									<input type="checkbox" name="sHobby" value="LOL">LOL
									<input type="checkbox" name="sHobby" value="WOW">WOW
									<input type="checkbox" name="sHobby" value="吃鸡">吃鸡
									<input type="checkbox" name="sHobby" value="王者">王者
								</td>
							</tr>
							<tr>
							<td>生日</td>
								<td>
									<input type="date" name="sBirth" id="sBirth">
								</td>
							</tr>
						</table>
	...
	function initEditUser(getSelection){
		...
		var hobbys= getSelection.sHobby;
